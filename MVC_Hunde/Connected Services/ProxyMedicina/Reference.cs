...
namespace MVC_Hunde.ProxyMedicina {
    ...
    public interface IServicioMedicina {
        ...
        MVC_Hunde.ProxyMedicina.Medicina[] ConsultarMedicinaProveedor(string codProv);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioMedicina/ConsultarMedicinaProveedor", ReplyAction="http://tempuri.org/IServicioMedicina/ConsultarMedicinaProveedorResponse")]
        System.Threading.Tasks.Task<MVC_Hunde.ProxyMedicina.Medicina[]> ConsultarMedicinaProveedorAsync(string codProv);
        ...
        MVC_Hunde.ProxyMedicina.Medicina[] ListarMedicinas();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioMedicina/ListarMedicinas", ReplyAction="http://tempuri.org/IServicioMedicina/ListarMedicinasResponse")]
        System.Threading.Tasks.Task<MVC_Hunde.ProxyMedicina.Medicina[]> ListarMedicinasAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicioMedicinaChannel : MVC_Hunde.ProxyMedicina.IServicioMedicina, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicioMedicinaClient : System.ServiceModel.ClientBase<MVC_Hunde.ProxyMedicina.IServicioMedicina>, MVC_Hunde.ProxyMedicina.IServicioMedicina {
        ...
        public MVC_Hunde.ProxyMedicina.Medicina[] ConsultarMedicinaProveedor(string codProv) {
            return base.Channel.ConsultarMedicinaProveedor(codProv);
        }
        
        public System.Threading.Tasks.Task<MVC_Hunde.ProxyMedicina.Medicina[]> ConsultarMedicinaProveedorAsync(string codProv) {
            return base.Channel.ConsultarMedicinaProveedorAsync(codProv);
        }
        
        public MVC_Hunde.ProxyMedicina.Medicina[] ListarMedicinas() {
            return base.Channel.ListarMedicinas();
        }
        
        public System.Threading.Tasks.Task<MVC_Hunde.ProxyMedicina.Medicina[]> ListarMedicinasAsync() {
